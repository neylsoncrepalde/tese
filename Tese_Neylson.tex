...
%	A segunda razão reside nas possibilidades de avanços tanto na socioeconomia brasileira quanto no entendimento do funcionamento das orquestras brasileiras e de seu mercado. \ldots
	...
	Após algumas considerações sobre as especificidades dos produtos culturais e após uma investigação preliminar sobre o modelo de financiamento da cultura vigente no Brasil, revisaremos agora a base teórica escolhida para análise, a perspectiva neoestrutural.
	...
	O modelo de análise pode ser visualizado de forma sintética na figura X.....
	
	% Inserir a figura com o modelo analítico
	
	
	
	\section{Dados e Métodos}
	
	Para isso vamos primeiro identificar e analisar as orquestras da cidade de Belo Horizonte incluindo sua região metropolitana e sua rede de parceiros comerciais. A escolha de Belo Horizonte se deu tendo em vista seu número relativamente pequeno de orquestras profissionais (em torno de cinco), o que viabiliza o trabalho de campo, além de sua reconhecida expressividade no cenário cultural nacional. 
