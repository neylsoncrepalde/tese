...
\end{SingleSpace}
	...
	Estimamos um ERGM para explicar os laços que compõem a rede multiplexo de prestígio. Assim procedemos pois não estamos interessados em explicar, necessariamente, os convites ou indicações para trabalho de forma efetiva ...
	...
	\begin{table}[!ht]
		...
		\label{ergm:prestigio-coefs}
			...
			{\begin{tabular}{p{7cm} c }
				...
				\hline
				Edges           		& $-4.07 \; (0.25)^{***}$ \\
				Geometrically weighted edgewise shared partner distribution           		& $2.90 \; (0.20)^{***}$  \\
				Geometrically weighted edgewise shared partner distribution: decay     		& $0.78 \; (0.65)$        \\
				Geometrically weighted in-degree distribution       		& $4.67 \; (0.55)^{***}$  \\
				Geometrically weighted in-degree distribution: decay 		& $-0.14 \; (0.07)^{*}$   \\
				2 Paths          		& $-1.46 \; (0.13)^{***}$ \\
				Homofilia (sexo)  		& $0.57 \; (0.20)^{**}$   \\
				Covariável (amizade)    & $3.09 \; (0.26)^{***}$  \\
				\hline
				AIC             & 1663.29                 \\
				BIC             & 1726.19                 \\
