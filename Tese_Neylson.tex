...
\end{SingleSpace}
	...
	O modelo teve um excelente ajuste. Os gráficos de avaliação de ajuste (\textit{goodness of fit}) mostram a adequação das redes simuladas aos dados observados. Em regras gerais a avaliação dos gráficos segue a seguinte lógica:......
