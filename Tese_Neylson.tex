...
%	\end{figure}
	...
	\begin{hip}
		Quanto maior a concentração de músicos prestigiosos uma orquestra tiver, melhor será sua qualidade percebida.
	\end{hip}
...
%	\end{figure}
	...
	Para testar as hipóteses traçadas no capítulo \ref{hipoteses}, utilizaremos o \textit{Network Autocorrelation Model} conforme especificado na Equação \ref{NAM}. Para elaborar um modelo que tivesse bom ajuste aos dados, estimamo um modelo linear generalizado com distribuição \textit{gamma} e link ``log''. Nosso modelo estimou a qualidade percebida de cada orquestra 
