...
%	\end{figure}
	...
	\begin{hip}\label{hip:incentivos}
		...
		Quanto mais uma orquestra provê incentivos para os músicos, melhor será sua qualidade percebida.
	\end{hip}
...
%	\end{figure}
	...
	\begin{table}[!htbp] 
		...
		{\begin{tabular}{@{\extracolsep{5pt}}lcccccc} 
			...
			\hline \\[-1.8ex] 
			Qualidade &  0.314 & 0.866 & 0.100 & 0.100 & 0.100 & 5.100 \\ 
			...
			Salário & 195.000 & 931.422 & 0 & 0 & 0 & 7,000 \\ 
	...
	\begin{table}[!ht]
		...
		{\begin{tabular}{l c c c c c c }
			...
			& $(0.01)$      & $(0.01)$      & $(0.00)$      & $(0.01)$      & $(0.01)$      & $(0.00)$      \\
			Cent. Grau                  & $0.03^{***}$  & $-0.10^{***}$ & $-0.07^{***}$ & $-0.08^{*}$   & $0.02^{***}$  & $-0.01^{***}$ \\
			...
			&               &               &               &               &               & $(0.01)$      \\
			\hline
			AIC                        & -329.87       & -370.08       & -496.39       & -336.66       & -332.87       & -636.36       \\
			BIC                        & -318.63       & -356.59       & -482.89       & -323.17       & -319.38       & -622.86       \\
			Log Likelihood             & 169.94        & 191.04        & 254.19        & 174.33        & 172.44        & 324.18        \\
			Deviance                   & 1.98          & 1.09          & 0.18          & 1.75          & 1.85          & 0.02          \\
	...
	Do terceiro e quarto modelos observaremos os resultados para as covariáveis exógenas salário e orçamento. Embora o salário tenha obtido um coeficiente significativo e positivo, o efeito é bastante pequeno. Já o orçamento obteve, como esperado, um efeito positivo e significativo. Esses resultados nos ajudam a testar \textit{H\ref{hip:incentivos}} e \textit{H\ref{hip:orcamento}};  \textit{H\ref{hip:orcamento}} foi confirmada pelo modelo. Já \textit{H\ref{hip:incentivos}} não pôde ser confirmada devido ao efeito muito pequeno da variável. 
	...
	Construímos um framework teórico a partir de quatro linhas teóricas, a saber, o modelo $W(y)$ de Harrison White, a arquitetura dos mercados de Fligstein, os isomorfismos do tipo normativos de \citeauthoronline{dimaggio1983iron} e as redes multinível conforme propostas por Lazega. Essas perspectivas se alinham na abordagem do fenômeno mercantil da música orquestral à medida que se complementam em aspectos importantes para a compreensão do objeto de estudo em questão....
	
	%DE QUE FORMA MEUS DADOS CONFIRMAM OU MODIFICAM A TEORIA?...........
	
	Todas as hipóteses que traçamos foram corroboradas com exceção de \textit{H\ref{hip:incentivos}}. Optamos por não dar a hipótese como corroborada devido ao efeito ínfimo da variável no modelo mesmo seu p-valor tendo indicado significância estatística. Foi possível verificar que a percepção da qualidade pelos músicos é fortemente afetada pela complexidade da estrutura relacional das organizações, pelo prestígio dos músicos que a compõem, pelo seu orçamento, pela complexidade organizacional e pela proximidade com o Estado. Esses achados nos permitem discutir alguns pontos centrais elencados pela teoria:
