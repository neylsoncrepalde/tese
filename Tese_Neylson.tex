...
%	\end{figure}
	...
	Estimamos um modelo de blocos para identificar subgrupos na estrutura gerada pelo compartilhamento de colaboradores (Figura \ref{sbmout:mesonivel2}). Tanto o modelo ``variacional'' quanto o modelo bayesiano identificaram dois blocos de nós estruturalmente equivalentes (Figura \ref{blocos:mesonivel2}).
