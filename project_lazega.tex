...
\tableofcontents
	...
	$$C(y, n) = q \cdot y^c \cdot n^d$$
        ...
        \item ``closenes to the state'' will be measured by the number of contracts signed and the total financing from State.
        \end{itemize}
        ...
        \begin{table}
          \ibgetab{
          \caption{Proposed indicators - $W(y)$ model}
