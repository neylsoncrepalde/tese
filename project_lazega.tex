...
\begin{document}
	...
	To deal with quality index $N$, the authors elaborate a sophisticated model to explain how various actors have a different influence on quality. To them,
	...
	In the last section, we reviewed briefly two implementations of the $W(y)$ model. Both works deal with the challenges quality imposes in a creative way taking into account both the complexity of the matter and the availability of data. 
