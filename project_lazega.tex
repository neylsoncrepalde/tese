...
\begin{document}
	...
	We argue that the concepts of a ``good orchestra'', a ``good performance'', a ``good instrumental technique'', emerge from the bottom up and not from top to bottom, that is, from individuals, not from meso level or structural level.
	...
	\begin{hip}
		...
		The State shapes the quality standard.
	\end{hip}
