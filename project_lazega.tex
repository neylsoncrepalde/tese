...
\begin{document}
	...
	\begin{table}[ht]
        ...
        \subsection{Evaluation of the orchestra goals}
        ...
        \subsubsection{Fund-raising and dependency on the State}
        ...
        \subsection{Repertoire and consumption}
        ...
        This proportions stay somewhat stable if we observe the main concert series (with the exception, of course, of the \textit{Fora de Série} thematic series). In Figure \ref{repertoire-perseries}, the Youth Concerts (in the middle column) seems to be the most balanced series. Allegro/Vivace and Presto/Veloce are quite alike. In 2016, 
