...
g\titulo{The social construction of quality in a Brazilian Classical Music market}
\autor{Neylson J. B. F. Crepalde (GIARS - UFMG) \and Dr. Silvio Salej Higgins - advisor (GIARS - UFMG) \and Dr. Emmanuel Lazega - co advisor (CSO - SciencesPo)}
\data{November, 2017}
...
\begin{document}
	...
	\citeonline{biencourt2002market} present a clever approach to this problem regarding theatres' market as we saw in the last section. We shall depart from their rationale to build the quality index $n$ we will use in this investigation. The author's idea of the judgement of public authorities is similar to our conception on how the variable should be measured. Indeed, the relation of each orchestra with the State is related to one of our main hypotheses.
	
	On the other hand, judgement of orchestral music critics is not something trivial because in Belo Horizonte's scenario, music critics' acting is not something so well defined as movie critics or theatre critics. Orchestral performances do not always get a critic on the main newspapers and there is not such a well structured platform for it as Rotten Tomatoes\footnote{\url{https://www.rottentomatoes.com}.} or \textit{Adoro Cinema}\footnote{A famous Brazilian movie critics website. Available in \url{http://www.adorocinema.com}.} This will lead to one of our main contributions with this investigation, the creation of an online platform for the evaluation of concerts by critics and the public. This will be discussed in further detail in the methodology section.
	...
	We will present next the second piece of our theoretical approach, Filgstein's theory.
	...
	We still need a deeper investigation on the acting processes of firms on a daily basis commiting in movements of competition and cooperation at the same time. Organizatinal isomorphisms is a concept that seems to throw light on these processes.
	...
	Therefore, normative isomorphism processes shed light on the observed behavior of the orchestras in general.
	...
	At this point, the various theoretical elements presented so far seem to converge in a complementary way. % EXPLAIN!!!
	One of our efforts in this work is to build a theoretical synthesis that is comprehensive enough to account for such a specific object. Next, we present the analysis model by which we will conduct the research.
	...
	% Éloire explica sua estratégia/abordagem das redes multiníveis a partir da página 252 da tese. COMPENSA OLHAR!!!
