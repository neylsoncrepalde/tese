...
\begin{document}
	...
	\subsection{2-mode transformations}
...
\bibliography{BIBDOUTORADO, abnt-options}
	...
	Here is a space for the beautiful intention of deriving the much very complicated White mathematical models\dots
        ...
        \section*{Appendix 3 -- Teacher/professor/hub's interview guide}

        Good day. I want to thank you very much for you participation and assure that it is extremely important for the success of my PhD research. Let's begin talking about your \textbf{musical training}:
