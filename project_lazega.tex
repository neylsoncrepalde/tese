...
\begin{document}
	...
	where the two main parameters are the exponents $c$ and $d$. In this formula, $q$ is a numerical scaling factor across all the firms, a constant, $y$ represents the volume of product commitment and $n$ is a quality component, the very identity of the product of that firm. Now, the $c$ exponent ...............
	...
	The central part of White's model is the market schedule, or the $W(y)$ function. ``The existence of one viable market seems to depend on only one simple question (\dots): does that approximation of a continuous function exist'' \cite[p. 219]{favereau2002markets}? 
